window.STUDY_DATA = {
  ...
  questions: [
    ...
    { id: "c8qnew8", chapter: 8, difficulty: "Hard", question: "A 'Qualified' audit opinion means:", options: ["The auditor approves the financials fully", "The auditor found a specific material issue but financials are not entirely misleading", "The auditor was unable to verify anything", "The auditor declared financials misleading"], answer: 1, explain: "Qualified = specific issue exists but the financials overall are not adverse. Unmodified = clean. Adverse = misleading. Disclaimer = could not verify. Tempting decoy 'approve fully' confuses Qualified with Unmodified." },
