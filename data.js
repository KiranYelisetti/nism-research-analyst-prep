window.STUDY_DATA = {
  ...
  questions: [
    { id: "c1h1", chapter: 1, difficulty: "Hard", question: "During a management meeting, the CFO discusses a publicly announced Rs 500 cr capex plan and also hints that the unannounced Q3 revenue will beat estimates. The analyst should:", options: ["Use the revenue hint only after cross-checking it with channel partners", "Publish using only the public capex information and disregard the revenue hint", "Delay the report until results are announced and adjust personal holdings meanwhile", "Include the hint but attribute it to unnamed sources"], answer: 1, explain: "The revenue hint is UPSI. It cannot be used, traded on, or passed on, no matter how it is verified or attributed. Public information remains fully usable." },
    { id: "c1h2", chapter: 1, difficulty: "Hard", question: "Which of the following is NOT a mandatory element of a research report?", options: ["Analyst certification that the views are the analyst's own", "Definitions of the rating terms used", "Price charts and graphs of the security", "Disclosure of 1% or more ownership in the subject company"], answer: 2, explain: "Charts and graphs are presentation aids, helpful but optional. Certification, rating definitions, and ownership disclosures are required." },
    { id: "c1h3", chapter: 1, difficulty: "Hard", question: "An RA publishes a Buy recommendation on a stock on March 10. Which personal transaction violates the trading restrictions?", options: ["Buying that stock on February 20", "Buying a different listed stock from the same sector on February 20", "Buying that stock on April 20", "Selling an unrelated index fund on March 12"], answer: 0, explain: "Reg 16 bars dealing in the subject company's securities 30 days before to 5 days after the report. Feb 20 falls inside the 30-day window; April 20 is outside the 5-day window." },
    { id: "c1h4", chapter: 1, difficulty: "Hard", question: "Which of the following qualifies as a research report under the RA Regulations?", options: ["A televised one-line market outlook", "An internal note prepared solely for the fund manager of the analyst's own AMC", "A published report with a Buy rating and target price distributed to clients", "General commentary on market trends without any security recommendation"], answer: 2, explain: "A research report is a communication with a recommendation on securities distributed to clients or the public. General commentary and purely internal buy-side notes are excluded." },
    { id: "c1h5", chapter: 1, difficulty: "Hard", question: "The RA's employer earned investment banking fees from the subject company 8 months ago. For a new report on that company, the RA must:", options: ["Refuse to cover the company until 24 months have passed", "Cover it but disclose the compensation received in the past 12 months", "Cover it without disclosure since the fee predates this report", "Disclose only if the fee exceeded 1% of the employer's revenue"], answer: 1, explain: "Compensation from the subject company within the preceding 12 months must be disclosed in the report. There is no revenue-percentage threshold and no coverage ban." },
    { id: "c1h6", chapter: 1, difficulty: "Hard", question: "The analyst certification in a research report primarily states that:", options: ["SEBI has reviewed and approved the report's contents", "The views expressed are the analyst's own and compensation is not linked to the specific recommendation", "The analyst guarantees the target price within the stated horizon", "The employer firm endorses the recommendation"], answer: 1, explain: "Certification is a personal declaration of independent views and unlinked compensation. SEBI never approves reports and no return can be guaranteed." },
    { id: "c2h1", chapter: 2, difficulty: "Hard", question: "A Nifty put option has strike 24,000 and was written for a premium of 150. At expiry Nifty is at 22,800. The put WRITER's net result per unit is:", options: ["Loss of 1,200", "Loss of 1,050", "Profit of 150", "Loss of 150"], answer: 1, explain: "The put is exercised: writer pays 24,000 minus 22,800 = 1,200, but keeps the 150 premium, so net loss 1,050. Forgetting the premium gives the 1,200 decoy." },
    { id: "c2h2", chapter: 2, difficulty: "Hard", question: "Same option: put strike 24,000 bought at a premium of 150. The BUYER's breakeven level at expiry is:", options: ["24,150", "23,850", "24,000", "22,800"], answer: 1, explain: "Put buyer breakeven = strike minus premium = 23,850. Adding the premium (24,150) is the call-side reflex, the classic decoy." },
    { id: "c2h3", chapter: 2, difficulty: "Hard", question: "An investor sells (writes) a call with strike 500 for a premium of 20. Maximum profit and maximum loss are:", options: ["Profit 20, loss unlimited", "Profit unlimited, loss 20", "Profit 480, loss 20", "Profit 20, loss 480"], answer: 0, explain: "A writer's best case is keeping the premium. A call writer's loss grows without limit as the price rises. 'Profit 20, loss 480' is the PUT writer's profile, the tempting decoy." },
    { id: "c2h4", chapter: 2, difficulty: "Hard", question: "Which market participant carries an OBLIGATION rather than a right?", options: ["Call option buyer", "Put option buyer", "Call option writer", "Any holder of an option contract"], answer: 2, explain: "Whoever receives the premium takes on the obligation. Buyers hold rights; writers must perform if assigned." },
    { id: "c2h5", chapter: 2, difficulty: "Hard", question: "Which institution guarantees settlement of trades executed on the exchange?", options: ["The stock exchange itself", "The clearing corporation", "The depository", "SEBI"], answer: 1, explain: "The clearing corporation becomes counterparty to both sides and guarantees settlement. The exchange matches orders; the depository holds securities; SEBI regulates." },
    { id: "c2h6", chapter: 2, difficulty: "Hard", question: "Shares held in dematerialised form are ultimately recorded with:", options: ["The stock exchange where they trade", "The clearing corporation", "The depository such as NSDL or CDSL", "SEBI's investor database"], answer: 2, explain: "Depositories keep the electronic record of ownership; investors access them through a Depository Participant." },
    { id: "c2h7", chapter: 2, difficulty: "Hard", question: "A listed company makes a fresh issue of shares while its existing shares continue trading on NSE. Which is correct?", options: ["Both activities are secondary market", "The fresh issue is primary market; the ongoing trading is secondary market", "Both become primary market until the new shares list", "The fresh issue is a money market operation"], answer: 1, explain: "New capital raised from investors = primary. Investor-to-investor trading of existing shares = secondary, even for the same company on the same day." },
    { id: "c2h8", chapter: 2, difficulty: "Hard", question: "A jeweller who must purchase gold in 3 months buys gold futures today. This is best described as:", options: ["Speculation on gold prices", "Hedging the input cost", "Arbitrage between spot and futures", "Pledging of commodities"], answer: 1, explain: "An existing business exposure offset with derivatives is hedging. Without the underlying need, the same trade would be speculation." },
    { id: "c2h9", chapter: 2, difficulty: "Hard", question: "Which position can lose far more than the amount initially paid or received, with no ceiling on the loss?", options: ["Buying a call option", "Buying a put option", "Selling stock futures", "Buying an index ETF"], answer: 2, explain: "Futures bind both sides: a short futures position loses without limit as prices rise. Option buyers can never lose more than the premium." },
    { id: "c3h1", chapter: 3, difficulty: "Hard", question: "A company has share price Rs 240, 50 crore shares, total debt Rs 400 crore, and cash of Rs 150 crore. Its enterprise value is:", options: ["Rs 12,000 crore", "Rs 12,250 crore", "Rs 12,400 crore", "Rs 12,550 crore"], answer: 1, explain: "EV = market cap 12,000 + debt 400 − cash 150 = 12,250. The decoys are market cap alone, forgetting cash, and adding cash instead of subtracting." },
    { id: "c3h2", chapter: 3, difficulty: "Hard", question: "A bond with face value Rs 1,000 and coupon 9% trades at Rs 1,125. Its current yield is:", options: ["9.0%", "8.0%", "11.25%", "4.5%"], answer: 1, explain: "Current yield = annual coupon / market PRICE = 90 / 1,125 = 8%. Using face value gives the 9% decoy." },
    { id: "c3h3", chapter: 3, difficulty: "Hard", question: "Which bond's price is MOST sensitive to a change in market interest rates?", options: ["2-year bond with 11% coupon", "10-year bond with 11% coupon", "10-year zero coupon bond", "2-year zero coupon bond"], answer: 2, explain: "Duration rises with longer maturity and lower coupon. A long-maturity zero coupon bond has the highest duration, so the biggest price swing." },
    { id: "c3h4", chapter: 3, difficulty: "Hard", question: "A stock trades at Rs 180 with EPS Rs 12 and DPS Rs 5. Which pair is correct?", options: ["P/E 15x and dividend payout about 41.7%", "P/E 36x and dividend payout about 41.7%", "P/E 15x and dividend payout about 2.4%", "P/E 36x and dividend payout about 240%"], answer: 0, explain: "P/E = 180/12 = 15x. Payout = DPS/EPS = 5/12 ≈ 41.7%. Using DPS in the P/E gives the 36x decoy." },
